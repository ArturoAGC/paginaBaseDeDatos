...
<body class="general" >
    <div>
            ...
            <div class="container-fluid contenedoragradecimiento align-items-cente">
                <div class="row">
                    <div class="col-lg-3 col-8 pt-4 pt-lg-4 mt-5 offset-2 offset-lg-5">
                        ...
                        <h1 class="textoagradecimiento">Modi. Contenido</h1>
        ...
        <div class="mt-3 row container  col-10 offset-1 col-lg-7 offset-lg-3">
            <div class="">
                <h2 class=" col-md-8 offset-md-2">¿Como se  modifica un contenido?</h2>
        ...
        <div id="lugares galeria" class="container">
            ...
            <div class="row container col-md-8 offset-md-2">
                ...
                <form action="script-modificar-contenido.php" method="get">
                    ...
                    <div class="mb-3 mt-5">
                        ...
                        <select type="text" class="form-select" id="tipo" placeholder="Poner tipo" name="tipo" value="<?php echo $contenido->get_tipo() ?>" required>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="textocorto" placeholder="Poner textocorto" name="textocorto" value="<?php echo $contenido->get_textocorto() ?>" >
                    </div>

                    <div class="mb-3 mt-3">
                        
                        <input type="text" class="form-control" id="textolargo" placeholder="Poner textolargo" name="textolargo" value="<?php echo $contenido->get_textolargo() ?>" >
                        
                    </div>

                    <div class="mb-3">
                        
                        <input type="text" class="form-control" id="clases" placeholder="Poner clases" name="clases" value="<?php echo $contenido->get_clases() ?>" >
                    </div>

                    <div class="mb-3">
                        
                        <input type="text" class="form-control" id="source" placeholder="Poner source" name="source" value="<?php echo $contenido->get_source() ?>" >
                    </div>

                    <div class="mb-3">
                        
                        <input type="text" class="form-control" id="orden" placeholder="Poner orden" name="orden" value="<?php echo $contenido->get_orden() ?>"  pattern ="[0-9]+">
                    </div>
